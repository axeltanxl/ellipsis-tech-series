    ...
    <Layout>
      <div className="flex flex-col w-[95%] mx-auto">
        <div className="w-full mt-8">
          {/* Map */}
          <div ref={mapElement} className="w-full h-96"></div>
        </div>

        <div className="my-10 bg-white rounded-lg shadow-lg p-6">
          <div className="flex flex-row p-4 -mb-2 items-start">
            {/* Search bar */}
            <div className="w-1/2 mb-4 pr-4 flex items-center">
              <input
                type="text"
                value={searchQuery}
              ...
              <button
                ...
                className="ml-2 px-4 py-2 bg-indigo-400 hover:bg-indigo-500 text-white rounded-lg border-0"
              >
                Search
              </button>
            </div>
                ...
                <div key={index} className="mb-4">
                  ...
                  <ul className="pl-4 mb-2">
                    {restaurant.locations.map((location, locationIndex) => (
                      <li key={locationIndex} className="list-disc">
                  ...
                  <ul className="pl-4">
                    {restaurant.available_options.map((food, foodIndex) => (
                      <li key={foodIndex} className="list-disc">
